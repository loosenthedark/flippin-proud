...
$(document).ready(function () {
  ...
  $.when($.ajax("static/data/data.json")).then(function (data) {
    for (let i = 0; i < data.length; i++) {
      ...
      flipCardFront +=
        "<img src='static/images/icons/pride-doughnut-icon.png' width='60' class='icon pride-doughnut-icon' alt='Pride doughnut icon'>";
      flipCardFront +=
        "<img src='static/images/icons/icon-flip-over.svg' width='60' class='icon flip-over-icon' alt='flip over icon'>";
      flipCardFront += "</div>";
